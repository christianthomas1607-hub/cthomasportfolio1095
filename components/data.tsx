...
export const WordAndImageData: WordAndImage[] = [
  ...
  //     ]
  //   ])
  //   twoColumn: new Map([["resilence-0.png", "test", "Sharp Corners According to various studies, sharp corners grab more attention. Using rounded corners on buttons that lead to sales would have less interactions."], ["resilence-1.png", "test1", "Title The large, bold, and yellow title or heading looks fairly hard to read. Yellow text on a white background has a very low contrast."]])
