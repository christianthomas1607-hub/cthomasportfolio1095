...
export interface WordAndImage extends MultiArray {
  title: string;
  imgMain: string;
  imgChild?: string;
...
const posts: WordAndImage[] = [
  {
    id: 1,
    title: 'Hello World',
    content: 'Welcome to learning React!',
    imgMain: '/images/hello.jpg',
    topDescription: 'Intro post with image'
  },
  {
    id: 2,
    title: 'Installation',
    content: 'You can install React from npm.',
    imgMain: '/images/install.jpg',
