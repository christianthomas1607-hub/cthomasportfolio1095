...
export const WordAndImage: WordAndImage[] = [
  ...
  { 
    ...
    twoColumn: new Map([["/images/resilence-1.png", "Sharp Corners According to various studies, sharp corners grab more attention. Using rounded corners on buttons that lead to sales would have less interactions."], ["cherry", "dark red"]])
