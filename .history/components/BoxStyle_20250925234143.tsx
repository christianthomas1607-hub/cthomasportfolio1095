...
import { WordAndImageData } from './data'


export default function BoxStyle(x: number = -3, y: number = 1.25, z: number, image: string, title: string, index: number) {
  return (
    <>
        <>
        <group position={[x, 1.25, z * 3.75]}>
          <mesh>
