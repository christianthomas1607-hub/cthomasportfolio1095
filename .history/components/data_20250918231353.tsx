...
export const WordAndImage: WordAndImage[] = [
  ...
  { 
    ...
    twoColumn: new Map([["resilence-1.png", "Sharp Corners According to various studies, sharp corners grab more attention. Using rounded corners on buttons that lead to sales would have less interactions."],["resilence-2.png", "Title
The large, bold, and yellow title or heading looks fairly hard to read. Yellow text on a white background has a very low contrast."],["cherry", "dark red"]])
