...
export const WordAndImage: WordAndImage[] = [
  ...
  { 
    ...
    twoColumn: new Map([["/images/resilence-0.png", "Sharp Corners According to various studies, sharp corners grab more attention. Using rounded corners on buttons that lead to sales would have less interactions."], ["/images/resilence-1.png", "Title
