...
export const WordAndImage: WordAndImage[] = [
  ...
  { 
    ...
    twoColumn: new Map([["apple", "Sharp Corners
...
​​​​​​​
Donate Button
Many company meetings were about how to receive donations to expand. The donate button used to require scrolling. I recommended we have it visible once the user enters. This caused an increase in donations."],["banana", "yellow"],["cherry", "dark red"]])
