export default function Popup({ onClose, item }: { onClose: () => void, item: { title: string, imgMain: string, imgChild?: string, description?: string, figma?: string} }) {
  return (
    <>
    <button
        id="popUpCloseButton"
...
{item?.figma &&
<iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://embed.figma.com/proto/W0r4eQk95RhVOoeFRxIx24/IDT535_Final_Project?node-id=20-353&starting-point-node-id=20%3A353&embed-host=share" allowfullscreen></iframe>
}
  </div>
  </>
  )
