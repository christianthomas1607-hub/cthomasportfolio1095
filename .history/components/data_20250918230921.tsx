...
export const WordAndImage: WordAndImage[] = [
  ...
  { 
    ...
    twoColumn: new Map([["apple", "Sharp Corners According to various studies, sharp corners grab more attention. Using rounded corners on buttons that lead to sales would have less interactions."],["banana", "yellow"],["cherry", "dark red"]])
