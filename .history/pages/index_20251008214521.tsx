...
const [selectedItem, setSelectedItem] = useState<WordAndImageType | null>(null)
  ...
  const spawnPosition: [number, number, number] = [0, 3.05, 0];
        ...
        >
          ...
          <RigidBody type="fixed" colliders="trimesh">
            ...
            {/* Use .89 for /images/star_destroyer_hallway.glb*/}
                ...
                </mesh> */}<Gltf castShadow receiveShadow position={[0, 4.5, 36]} rotation={[0, -Math.PI / 2, 0]} scale={2} src="/images/hall-transformed_V2.glb" />
