...
const [selectedItem, setSelectedItem] = useState<typeof WordAndImageType | null>(null)
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', overflow: 'hidden', margin: 0 }}>
      {showPopup ? <Popup onClose={handleClosePopup} item={typeof selectedItem}  /> : null}
       ...
       {/*  .7 intensity for original glb setting */}
        ...
        <Physics timeStep="vary">
          ...
          <RigidBody type="fixed" colliders="trimesh">
            ...
            <Gltf castShadow receiveShadow position={[0, 1.7, 27]} rotation={[0, -Math.PI / 2, 0]} scale={1.5} src="/images/hall-transformed.glb" />
          </RigidBody>
        </Physics>
      </Canvas>
    </div>
