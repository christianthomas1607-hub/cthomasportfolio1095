  ...
  return (
    <div style={{ width: '100vw', height: '100vh', overflow: 'hidden', margin: 0 }}>
      ...
      <div style={{ position: "absolute", bottom: 20, left: 20, zIndex: 1000 }}>
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" mr viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="3.25" stroke-linecap="butt" stroke-linejoin="arcs"><path d="M12 19V6M5 12l7-7 7 7"/>
          </svg>
