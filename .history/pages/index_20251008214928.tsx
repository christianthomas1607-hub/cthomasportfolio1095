...
const [selectedItem, setSelectedItem] = useState<WordAndImageType | null>(null)
  ...
  const spawnPosition: [number, number, number] = [0, 3.5, 0];
        ...
        >
          <KeyboardControls map={keyboardMap}>
            ...
            >
              ...
              {/* <Gltf castShadow receiveShadow scale={.005} position={[0, -.75, 0]} src="/images/r2d2.glb" /> */}
              <Gltf castShadow receiveShadow scale={.1} position={[0, 1, 0]} src="/images/probe-transformed.glb" />
            </Controller>
          </KeyboardControls>
          <RigidBody type="fixed" colliders="trimesh">
            ...
            {/* Use .89 for /images/star_destroyer_hallway.glb*/}
                ...
                <meshStandardMaterial/>
                 ...
                 {/* <Gltf castShadow receiveShadow position={[0, 4.5, 36]} rotation={[0, -Math.PI / 2, 0]} scale={2} src="/images/hall-transformed_V2.glb" /> */}
