...
import { Gltf, KeyboardControls, useKeyboardControls } from '@react-three/drei'
...
export default function Page() {
  ...
  const setControlsRef = useRef<null | ((fn: any) => void)>(null)

  // Helper to handle button press/release
  const handleControl = (name: string, pressed: boolean) => {
  if (setControlsRef.current) {
    setControlsRef.current((state: any) => {
      console.log('Setting', name, pressed)
