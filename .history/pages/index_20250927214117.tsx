...
const [selectedItem, setSelectedItem] = useState<WordAndImageType | null>(null)
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', overflow: 'hidden', margin: 0 }}>
      ...
      <Canvas attach="background" args={["white"]} >
       {/*  .7 intensity for original glb setting */}
        ...
        <Physics timeStep="vary">
          ...
          <RigidBody type="fixed" colliders="trimesh">
            <TexturedBox onClick={handleBoxClick} />
                ...
                <boxGeometry args={[8, 0, 31]} />
                  <meshBasicMaterial>
                    ...
                    colors={['#ff0000','#cf3030', '#851919']} // Define the colors at each stop (red to blue)
            ...
            <Gltf castShadow receiveShadow position={[0, 4.75, 27]} rotation={[0, -Math.PI / 2, 0]} scale={1} src="/images/hall-transformed.glb" />
